...
import { Trophy, Flame, Star, Copy, Users, Check, Edit2, ArrowRightLeft, Shield, UserPlus } from 'lucide-react';
...
export default function Profile() {
    const { profile, user, family, myFamilies, signOut, refreshProfile, switchFamily, leaveFamily } = useAuth();
                ...
                <div className="p-4 bg-white rounded-xl border border-slate-100 shadow-sm space-y-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-medium text-slate-700">Google Account</p>
                                <p className="text-xs text-slate-400">
