...
import { View, Text, StyleSheet, TouchableOpacity, Alert, ScrollView, Modal, FlatList, Linking } from 'react-native';
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
                        <Shield size={20} color="#10b981" style={{ marginRight: 6 }} />
                        <Text style={[styles.sectionTitle, { marginBottom: 0 }]}>Account Security</Text>
                    </View>
                    <Card style={{ padding: 16 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                                <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: '#f8fafc', justifyContent: 'center', alignItems: 'center', marginRight: 12 }}>
                                ...
                                <View style={{ flex: 1 }}>
                                    <Text style={{ fontSize: 16, fontWeight: '600', color: '#334155' }}>Google Account</Text>
                            ...
                            {user?.identities?.some((i: any) => i.provider === 'google') ? (
                                <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#ecfdf5', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 }}>
                                    <Check size={16} color="#059669" style={{ marginRight: 4 }} />
                                    <Text style={{ color: '#059669', fontWeight: 'bold', fontSize: 12 }}>Linked</Text>
                                </View>
                            ) : (
                                <Button
                                    title="Link"
